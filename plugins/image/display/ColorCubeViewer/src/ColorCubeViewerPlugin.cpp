...
#include "ColorCubeViewerProcess.hpp"
...
ColorCubeViewerPlugin::ColorCubeViewerPlugin(OfxImageEffectHandle handle)
...
ColorCubeViewerPlugin::getProcessParams(const OfxPointD& renderScale) const
{
    ColorCubeViewerProcessParams<Scalar> params; // create parameters container object
 ...
 */
void ColorCubeViewerPlugin::changedParam(const OFX::InstanceChangedArgs& args, const std::string& paramName)
{
 ...
 * If clip has changed
 */
void ColorCubeViewerPlugin::changedClip(const OFX::InstanceChangedArgs& args, const std::string& clipName)
{
...
bool ColorCubeViewerPlugin::isIdentity(const OFX::RenderArguments& args, OFX::Clip*& identityClip, double& identityTime)
{
    //	ColorCubeViewerProcessParams<Scalar> params = getProcessParams();
 ...
 */
void ColorCubeViewerPlugin::render(const OFX::RenderArguments& args)
{
    ...
    doGilRender<ColorCubeViewerProcess>(*this, args); // launch process
}
 ...
 * @param args
 */
void ColorCubeViewerPlugin::updateGeodesicForms(const OFX::InstanceChangedArgs& args)
{
 ...
 * @param args
 */
void ColorCubeViewerPlugin::updateProcessGeodesicForms(const OFX::RenderArguments& args)
{
    // update time
...
void ColorCubeViewerPlugin::addRefCloudPointData()
{
...
void ColorCubeViewerPlugin::releaseCloudPointData()
{
...
bool ColorCubeViewerPlugin::hasCloudPointData() const
{
    return _cloudPointDataCount != 0;
}

CloudPointData& ColorCubeViewerPlugin::getCloudPointData()
{
    return *_cloudPointData.get();
}
const CloudPointData& ColorCubeViewerPlugin::getCloudPointData() const
{
    return *_cloudPointData.get();
}
/// @}
