    ...
    : GeneratorPlugin(handle)
{
    ...
    _paramFontPath = fetchStringParam(kParamFontPath);
#ifndef __WINDOWS__
...
TextProcessParams TextPlugin::getProcessParams(const OfxPointD& renderScale) const
{
    ...
    params._fontPath = _paramFontPath->getValue();
#ifndef __WINDOWS__
...
void TextPlugin::render_if(const OFX::RenderArguments& args, boost::mp11::mp_true)
{
    typedef typename View::value_type Pixel;
...
template <class View, template <typename> class Functor>
void TextPlugin::render_if(const OFX::RenderArguments& args, boost::mp11::mp_false)
{
