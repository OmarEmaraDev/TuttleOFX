...
void AVReaderPluginFactory::describe(OFX::ImageEffectDescriptor& desc)
{
    ...
    desc.setLabels("TuttleAVReader", "AVReader", "Audio Video reader");
    ...
    supportedExtensions.erase(std::unique(supportedExtensions.begin(), supportedExtensions.end()),
 ...
 */
OFX::ImageEffect* AVReaderPluginFactory::createInstance(OfxImageEffectHandle handle, OFX::EContext context)
{
