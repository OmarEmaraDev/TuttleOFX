    ...
    , _interactScene(*effect, _infos)
{
    ...
    interact::InteractObject* objCanonical =
        new interact::ParamRectangleFromCenterSize<interact::FrameClip, eCoordinateSystemXY>(
            _infos, _plugin->_paramRectCenter, _plugin->_paramRectSize, interact::FrameClip(_plugin->_clipSrc));
    interact::InteractObject* objNormalized =
        new interact::ParamRectangleFromCenterSize<interact::FrameClip, eCoordinateSystemXYn>(
            _infos, _plugin->_paramRectCenter, _plugin->_paramRectSize, interact::FrameClip(_plugin->_clipSrc));
