...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        inputBuffer1.setRawImageBuffer((void*)boost::gil::interleaved_view_get_raw_data(imgView), imgView.width(),
                                       imgView.height(), InputBufferWrapper::ePixelComponentAlpha,
                                       InputBufferWrapper::eBitDepthUByte, imgView.pixels().row_size(),
        ...
        boost::gil::gray8_view_t imgResView =
            imgRes->getGilView<boost::gil::gray8_view_t>(tuttle::host::attribute::Image::eImageOrientationFromTopToBottom);
        boost::gil::png_write_view("data/canny/manual_output.png",
                                   boost::gil::color_converted_view<boost::gil::rgb8_pixel_t>(imgResView));
    }
