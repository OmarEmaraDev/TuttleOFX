...
struct pixel_scale_t
{
        ...
        : _ratio(ratio)
    {
        ...
        pixel_assigns_t<CPixel, CPixel>()(
            pixel_minus_t<CPixel, CPixel, CPixel>()(dCenter, pixel_multiplies_t<CPixel, CPixel, CPixel>()(sCenter, ratio)),
            _shift);
    }
    ...
    Pixel operator()(const Pixel& src) const
    {
        ...
        pixel_assigns_t<CPixel, Pixel>()(
            pixel_plus_t<CPixel, CPixel, CPixel>()(pixel_multiplies_t<Pixel, CPixel, CPixel>()(src, _ratio), _shift), res);
