...
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64, uint64_t, gray)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64s, int64_t, gray)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64f, double, gray)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64, uint64_t, bgr)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64s, int64_t, bgr)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64f, double, bgr)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64, uint64_t, argb)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64s, int64_t, argb)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64f, double, argb)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64, uint64_t, abgr)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64s, int64_t, abgr)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64f, double, abgr)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64, uint64_t, bgra)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64s, int64_t, bgra)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(64f, double, bgra)

BOOST_GIL_DEFINE_ALL_TYPEDEFS(64, uint64_t, rgb)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(64s, int64_t, rgb)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(64f, double, rgb)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(64, uint64_t, rgba)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(64s, int64_t, rgba)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(64f, double, rgba)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(64, uint64_t, cmyk)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(64s, int64_t, cmyk)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(64f, double, cmyk)

template <int N>
struct devicen_t;
template <int N>
struct devicen_layout_t;
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64, uint64_t, dev2n, devicen_t<2>, devicen_layout_t<2>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64s, int64_t, dev2n, devicen_t<2>, devicen_layout_t<2>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64f, double, dev2n, devicen_t<2>, devicen_layout_t<2>)

BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64, uint64_t, dev3n, devicen_t<3>, devicen_layout_t<3>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64s, int64_t, dev3n, devicen_t<3>, devicen_layout_t<3>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64f, double, dev3n, devicen_t<3>, devicen_layout_t<3>)

BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64, uint64_t, dev4n, devicen_t<4>, devicen_layout_t<4>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64s, int64_t, dev4n, devicen_t<4>, devicen_layout_t<4>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64f, double, dev4n, devicen_t<4>, devicen_layout_t<4>)

BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64, uint64_t, dev5n, devicen_t<5>, devicen_layout_t<5>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64s, int64_t, dev5n, devicen_t<5>, devicen_layout_t<5>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(64f, double, dev5n, devicen_t<5>, devicen_layout_t<5>)
...
typedef bit_aligned_pixel_reference<uint32_t, mp11::mp_list_c<uint10_t, 10, 10, 10>, rgb_layout_t, true> rgb10_stream_ref_t;
...
typedef bit_aligned_pixel_reference<uint64_t, mp11::mp_list_c<uint10_t, 10, 10, 10, 10>, rgba_layout_t, true>
    rgba10_stream_ref_t;
...
typedef bit_aligned_pixel_reference<uint64_t, mp11::mp_list_c<uint10_t, 10, 10, 10, 10>, abgr_layout_t, true>
    abgr10_stream_ref_t;
...
typedef bit_aligned_pixel_reference<uint64_t, mp11::mp_list_c<uint12_t, 12, 12, 12>, rgb_layout_t, true> rgb12_stream_ref_t;
...
typedef bit_aligned_pixel_reference<uint64_t, mp11::mp_list_c<uint12_t, 12, 12, 12, 12>, rgba_layout_t, true>
    rgba12_stream_ref_t;
...
typedef bit_aligned_pixel_reference<uint64_t, mp11::mp_list_c<uint12_t, 12, 12, 12, 12>, abgr_layout_t, true>
    abgr12_stream_ref_t;
...
typedef mp11::mp_list<rgba12_packed_channel0_t, rgba12_packed_channel1_t, rgba12_packed_channel2_t, rgba12_packed_channel3_t>
...
typedef mp11::mp_list<abgr12_packed_channel0_t, abgr12_packed_channel1_t, abgr12_packed_channel2_t, abgr12_packed_channel3_t>
...
typedef mp11::mp_list<rgb12_packed_channel0_t, rgb12_packed_channel1_t, rgb12_packed_channel2_t> rgb12_packed_channels_t;
...
typedef mp11::mp_list<rgb10_packed_channel0_t, rgb10_packed_channel1_t, rgb10_packed_channel2_t> rgb10_packed_channels_t;
...
typedef mp11::mp_list<rgba10_packed_channel0_t, rgba10_packed_channel1_t, rgba10_packed_channel2_t, rgba10_packed_channel3_t>
...
typedef mp11::mp_list<abgr10_packed_channel0_t, abgr10_packed_channel1_t, abgr10_packed_channel2_t, abgr10_packed_channel3_t>
...
BOOST_GIL_DEFINE_BASE_TYPEDEFS(10, uint10_t, gray)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(10, uint10_t, bgr)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(10, uint10_t, argb)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(10, uint10_t, bgra)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(10, uint10_t, abgr)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(10, uint10_t, rgb)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(10, uint10_t, rgba)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(10, uint10_t, cmyk)

BOOST_GIL_DEFINE_BASE_TYPEDEFS(12, uint12_t, gray)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(12, uint12_t, bgr)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(12, uint12_t, argb)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(12, uint12_t, bgra)
BOOST_GIL_DEFINE_BASE_TYPEDEFS(12, uint12_t, abgr)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(12, uint12_t, rgb)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(12, uint12_t, rgba)
BOOST_GIL_DEFINE_ALL_TYPEDEFS(12, uint12_t, cmyk)

BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(10, uint10_t, dev2n, devicen_t<2>, devicen_layout_t<2>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(10, uint10_t, dev3n, devicen_t<3>, devicen_layout_t<3>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(10, uint10_t, dev4n, devicen_t<4>, devicen_layout_t<4>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(10, uint10_t, dev5n, devicen_t<5>, devicen_layout_t<5>)

BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(12, uint12_t, dev2n, devicen_t<2>, devicen_layout_t<2>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(12, uint12_t, dev3n, devicen_t<3>, devicen_layout_t<3>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(12, uint12_t, dev4n, devicen_t<4>, devicen_layout_t<4>)
BOOST_GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(12, uint12_t, dev5n, devicen_t<5>, devicen_layout_t<5>)
}
}
