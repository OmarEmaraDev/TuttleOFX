...
Pixel clearChannel(const Pixel& in, bool red, bool green, bool blue, bool alpha, const boost::mpl::true_,
...
template <class Pixel>
Pixel clearChannel(const Pixel& in, bool red, bool green, bool blue, bool alpha, const boost::mpl::false_,
                   const boost::mpl::true_)
{
    return in;
}
...
struct RampFunctor
{
    ...
    RampFunctor() {}
    RampFunctor(const point_t& tileSize, const value_type& start_color, const value_type& end_color, bool horizontal = true,
