                                 ...
                                 const typename View::value_type& pixelValue)
{
    ...
    View dst = subimage_view(dstView, window.x1, window.y1, window.x2 - window.x1, window.y2 - window.y1);
 ...
 *
 * @param[out] dstBegin Begining of the region to fill. The content is filled but the original iterator is not modified (not
