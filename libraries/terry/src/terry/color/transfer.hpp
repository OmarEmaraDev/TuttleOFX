...
const typename pixel_rgb_to_lms_t<PixelRef, PixelR>::MatrixContants
    pixel_rgb_to_lms_t<PixelRef, PixelR>::_matrices; // init static variable.
...
struct pixel_rgb_to_lab_t
{
    ...
    PixelR operator()(const PixelRef& rgb) const
    {
        ...
        PixelR lms_log = pixel_log10_t<PixelR, PixelR>()(
            ...
            pixel_clamp_lower_than_t<PixelR>(channelThresold, channelThresold)(lms));
...
template <typename PixelRef, typename PixelR>
const typename pixel_rgb_to_lab_t<PixelRef, PixelR>::MatrixContants
    pixel_rgb_to_lab_t<PixelRef, PixelR>::_matrices; // init static variable.
...
template <typename PixelRef, typename PixelR>
const typename pixel_lms_to_rgb_t<PixelRef, PixelR>::MatrixContants
    pixel_lms_to_rgb_t<PixelRef, PixelR>::_matrices; // init static variable.
...
template <typename PixelRef, typename PixelR>
const typename pixel_lab_to_rgb_t<PixelRef, PixelR>::MatrixContants
    pixel_lab_to_rgb_t<PixelRef, PixelR>::_matrices; // init static variable.
}
}
}
