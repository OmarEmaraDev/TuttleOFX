...
{
    static const ECoordinateSystem value = eCoordinateSystemXY;
};
template <>
struct NotCenteredCoodinate<eCoordinateSystemXYcn>
{
    static const ECoordinateSystem value = eCoordinateSystemXYn;
};
template <>
struct NotCenteredCoodinate<eCoordinateSystemXXc>
{
    static const ECoordinateSystem value = eCoordinateSystemXX;
};
template <>
...
{
    static const ECoordinateSystem value = eCoordinateSystemXXc;
};
template <>
...
{
    static const ECoordinateSystem value = eCoordinateSystemXYcn;
};
template <>
...
inline Point2Double pointConvertCoordinateSystem(const Point2Double& point, const Point2Double& imgSize)
{
...
template <>
inline Point2Double pointConvertCoordinateSystem<eCoordinateSystemXYn, eCoordinateSystemXY>(const Point2Double& point,
                                                                                            const Point2Double& imgSize)
{
...
template <>
inline Point2Double pointConvertCoordinateSystem<eCoordinateSystemXY, eCoordinateSystemXXn>(const Point2Double& point,
                                                                                            const Point2Double& imgSize)
{
...
template <>
inline Point2Double pointConvertCoordinateSystem<eCoordinateSystemXXn, eCoordinateSystemXX>(const Point2Double& point,
                                                                                            const Point2Double& imgSize)
{
...
template <>
inline Point2Double pointConvertCoordinateSystem<eCoordinateSystemXXn, eCoordinateSystemXY>(const Point2Double& point,
                                                                                            const Point2Double& imgSize)
{
