...
public:
    ...
    {
        return canonicalXXToNormalizedXX(point, _projectSize);
    }
    template <typename Value>
    Value normalizedXXToCanonicalXX(const Value& point) const
    {
        return normalizedXXToCanonicalXX(point, _projectSize);
    }

    template <typename Value>
    Value pointCanonicalXYToNormalizedXY(const Value& point) const
    {
        return pointCanonicalXYToNormalizedXY(point, _projectSize);
    }
    template <typename Point>
    Point pointNormalizedXYToCanonicalXY(const Point& point) const
    {
        return pointNormalizedXYToCanonicalXY(point, _projectSize);
    }
