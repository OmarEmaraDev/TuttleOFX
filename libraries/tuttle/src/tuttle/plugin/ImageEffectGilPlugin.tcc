...
void doGilRender(Plugin& plugin, const OFX::RenderArguments& args, const OFX::EPixelComponent component,
    ...
    switch(component)
    {
        ...
        case OFX::ePixelComponentNone:
        {
            BOOST_THROW_EXCEPTION(exception::Unsupported() << exception::user() + "Pixel component (" +
                                                                  mapPixelComponentEnumToString(component) +
...
void doGilRender2(Plugin& plugin, const OFX::RenderArguments& args, const OFX::EPixelComponent dComponent,
...
void doGilRender2(Plugin& plugin, const OFX::RenderArguments& args, const bool dPlanar,
...
void doGilRender2(Plugin& plugin, const OFX::RenderArguments& args, const OFX::EBitDepth sBitDepth, const bool dPlanar,
                  const OFX::EPixelComponent dComponent, const OFX::EBitDepth dBitDepth)
{
    switch(sBitDepth)
    {
...
void doGilRender2(Plugin& plugin, const OFX::RenderArguments& args, const OFX::EPixelComponent sComponent,
                  ...
                  const OFX::EBitDepth dBitDepth)
{
    switch(sComponent)
    {
        case OFX::ePixelComponentRGBA:
        {
            doGilRender2<Process, sPlanar, boost::gil::rgba_layout_t>(plugin, args, sBitDepth, dPlanar, dComponent,
                                                                      dBitDepth);
            return;
        }
        case OFX::ePixelComponentRGB:
        {
            doGilRender2<Process, sPlanar, boost::gil::rgb_layout_t>(plugin, args, sBitDepth, dPlanar, dComponent,
                                                                     dBitDepth);
            return;
        }
        case OFX::ePixelComponentAlpha:
        {
            doGilRender2<Process, sPlanar, boost::gil::gray_layout_t>(plugin, args, sBitDepth, dPlanar, dComponent,
                                                                      dBitDepth);
            return;
        }
        case OFX::ePixelComponentCustom:
...
void doGilRender2(Plugin& plugin, const OFX::RenderArguments& args, const bool sPlanar,
...
{
    doGilRender2<Process, Plugin>(plugin, args, false, sClip.getPixelComponents(), sClip.getPixelDepth(), false,
...
template <template <class, class, class> class Process, bool s1planar, class S1Layout, class S1Bits, bool s2planar,
          class S2Layout, class S2Bits, bool dPlanar, class DLayout, class DBits, class Plugin>
